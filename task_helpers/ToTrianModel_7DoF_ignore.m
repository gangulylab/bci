...
idx=1;
condn_data{1}=[D1(idx:end,:) ]'; % act1
condn_data{2}= [D2(idx:end,:)]'; % act2
condn_data{3}=[D3(idx:end,:)]'; % act3
condn_data{4}=[D4(idx:end,:)]'; % act4
...
% genFunction(net,'MLP_7Dir_B1_04042023_NoPooling_Update2') ;
...
net = train(net,N,T','UseParallel','no');
cd('/home/ucsf/Projects/bci/clicker')
genFunction(net,'MLP_7Dir_B1_20240612_CL1')
save net net
% %%%%%%%%%%%%%%%%%%%%%%% END SECTION %%%%%
% 
% 
