...
clc;clear
% enter the root path from the Data folder
root_path = '/home/ucsf/Data/bravo1/20220629/Robot3DArrow';
% enter the folder names for the Task. These can be increased as more data
% is collected. For exaple: 
...
foldernames = {'133823', '134413', '134803', '135149'};
...
% ROBOT BATCH
root_path = '/home/ucsf/Data/bravo1/20220629/RealRobotBatch';
foldernames = {};
...
% 87 of GetParams
net_new_7DoF_ZWrist_06292022C = net;

% save the weights
cd('/home/ucsf/Projects/bci/clicker')
save net_new_7DoF_ZWrist_06292022C net_new_7DoF_ZWrist_06292022C
classifier_name = 'MLP_7DoF_ZWrist_06292022C'; % enter the name
genFunction(net_new_7DoF_ZWrist_06292022C,classifier_name);
