...
% get the files
files_train=[];
for j=1:7%length(folders_train)
...
cd(clicker_path)
net_bilstm_9DoF_update_20230818 = goat_model.net;
save net_bilstm_9DoF_update_20230818 net_bilstm_9DoF_update_20230818
