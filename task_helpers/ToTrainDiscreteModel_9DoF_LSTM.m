...
% get the files
files_train=[];
for j=1:4%length(folders_train)
...
cd(clicker_path)
net_bilstm_9DoF_update_20230809 = goat_model.net;
save net_bilstm_9DoF_update_20230809 net_bilstm_9DoF_update_20230809
