...
%% Instructed Delay (STATE 1)
% display the bar and nothing else
...
%% Cue time STATE 2
% display smaller bar with red color
...
%% Go to reach target STATE 3
% smaller bar green color under active control 
if ~Data.ErrorID,
    tstart  = GetSecs;
    Data.Events(end+1).Time = tstart;
