...
if Params.NeuralNetFlag
    ...
    Params.NeuralNetFunction = 'MLP_9DoF_Update01';
...
Params.ReachTargetPositions = [-0.5*Params.ReachTargetRadius, 0, 0;...
    0, 0, -0.5*Params.ReachTargetRadius;
    0,0,0;
    0,0,0];
...
Params.TargetOrder          = [1,2,1,2,1,2];
...
Params.index = 1;
Params.clickOrder = [8*ones(1,5*8)];
end % GetParams
