        ...
        if (tim-Cursor.LastPredictTime) > 1/Params.ScreenRefreshRate,
            ...
            if TargetID
                ...
                if Params.RobotClicker
                    ...
                    if mean(StopClicker_Buffer) > Params.ClickerBinThresh    % Exceeds clicker threshold
                               
                        fwrite(Params.udp, [0, 6, 0])   % Change color for click
                        subTask = subTask + 1;  
                        
                       
       
                        if subTask > Params.numTargets  % Done with all targets
                            done = 1;
