...
hold on
axis equal
plot(Params.ReachTargets(:,1), Params.ReachTargets(:,2), 'o')
...
%     reshape(repmat(1:Params.NumTargets2,Params.NumTargets1,1),[],1) ];
...
elseif Params.AssistMode == 1
    ...
    Params.AssistGain           = 1.; 
    Params.AssistThresh         = 0.05;
    if Params.NumTargets == 8
        Params.AssistThresh         = 0.15;
    elseif Params.NumTargets == 16
        Params.AssistThresh = 0.05;
    end
    Params.AssistLock           = 0;
    Params.RobotClicker         = 1;
