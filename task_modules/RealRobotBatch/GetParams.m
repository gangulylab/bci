...
Params.LSTMFunctionName = 'net_bilstm_robot_20220824_update_1129';%'net_bilstm_20220824_update'; %'net_bilstm_robot_20220824';%'net_bilstm_20220929_update';% or use 'net_bilstm_20220824';
Params.LSTM = load(fullfile('clicker',Params.LSTMFunctionName));
Params.LSTM = Params.LSTM.net_bilstm_robot_20220824_update_1129; % net_bilstm_robot_20220824; %net_bilstm_20220929_update; % or use net_bilstm_20220824
Params.LSTMBufferSize = 1000;
Params.SaveLSTMFeatures = false;
