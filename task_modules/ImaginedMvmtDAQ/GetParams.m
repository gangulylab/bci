...
%% List of imagined movements
Params.ImaginedMvmt = {'Right Thumb','Right Index','Right Middle','Right Ring','Right Pinky',...
    'Right Pinch Grasp','Right Tripod Grasp','Right Power Grasp','Squeeze Both Hands','Rotate Right Wrist'};
% ,...
%     'Imagined Head Movement','Left Thumb','Left Index','Left Middle','Left Ring','Left Pinky',......
%     'Right Shoulder Shrug',...
% 'Left Pinch Grasp','Left Tripod Grasp','Left Power Grasp',,'Rotate Left Wrist'...
%     'Left Shoulder Shrug',...
...
%% Target order for imagined movements
% Just do 1 block at a time (30 trials in total).
Params.TargetList = randperm(length(Params.ImaginedMvmt));
...
Params.NumTrialsPerBlock    = length(Params.TargetList);

%% To get ERPs
% freezes real-time updates for DAQ
Params.ERPs=true;
...
Params.TargetRectSize = 200; % size of the squares that act as cues
Params.TargetFontSize = 150; % size of the text that appears as instructions
