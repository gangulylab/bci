...
%               Not setting y and z axis velocities to stay on x axis
...
%                 Cursor.State = A*Cursor.State + (1-Params.AssistAlpha)*B*U + AssistVel;
                Cursor.State = A*Cursor.State + B*BetaScalar*U;
            ...
            % Send BetaScalar to update Beta line

            [xa,xb,xc] = doubleToUDP(BetaScalar);
            fwrite(Params.udp, [0, 23, xa,xb,xc,0,0,0,0,0,0,0]);
