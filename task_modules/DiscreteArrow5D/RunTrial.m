...
if ~Data.ErrorID && Params.CueTime>0
    ...
    while ~done
        ...
        if (tim-Cursor.LastPredictTime) > 1/Params.ScreenRefreshRate
            ...
            if Data.TargetID == 5
            Screen('FillOval', Params.WPTR, ...
                Params.CuedTargetColor, CircRect')
            else           
            Screen('FillOval', Params.WPTR, ...
                Params.InnerCircleColor, CircRect')
            end
...
if ~Data.ErrorID
    ...
    while ~done
        ...
        if (tim-Cursor.LastPredictTime) > 1/Params.ScreenRefreshRate,
            ...
            if Click_Decision == 5
                    Screen('DrawLine', Params.WPTR, [255 0 0],Params.Center(1)+ 0,Params.Center(2)-100,...
                    Params.Center(1) + 0,Params.Center(2) + 100,3);
                    Screen('DrawLine', Params.WPTR, [255 0 0],Params.Center(1) -100,Params.Center(2)+0,...
                    Params.Center(1)+100,Params.Center(2)+0,3);
            else
