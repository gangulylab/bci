...
Params.LSTMFunctionName = 'net_bilstm_5DoF_update_20230906_3';%'net_bilstm_20220929_update';% or use 'net_bilstm_20220824';
Params.LSTM = load(fullfile('clicker',Params.LSTMFunctionName));
Params.LSTM = Params.LSTM.net_bilstm_5DoF_update_20230906_3; %net_bilstm_20220929_update; % or use net_bilstm_20220824
