...
class JacoEnv(object):
  ...
  def set_cubeColor(self, pos, c):
    # p.removeUserDebugItem(self.l1)
    # p.removeUserDebugItem(self.l2)
    # p.removeUserDebugItem(self.l3)
    # p.removeUserDebugItem(self.l4)
    # p.removeUserDebugItem(self.l5)
    # p.removeUserDebugItem(self.l6)
    # p.removeUserDebugItem(self.l7)
    # p.removeUserDebugItem(self.l8)
    # p.removeUserDebugItem(self.l9)
    # p.removeUserDebugItem(self.l10)
    # p.removeUserDebugItem(self.l11)
    # p.removeUserDebugItem(self.l12)
    # self.drawAxes()
    lw = 16
